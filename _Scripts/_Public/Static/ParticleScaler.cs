...
public class ParticleScaler : MonoBehaviour
{
    ...
    void ScaleLegacySystems(float scaleFactor)
    {
        ...
        ParticleSystemRenderer[] emitters = GetComponentsInChildren<ParticleSystemRenderer>();

        //apply scaling to emitters
        foreach (ParticleSystemRenderer emitter in emitters)
        {
            emitter.maxParticleSize *= scaleFactor;
            emitter.minParticleSize *= scaleFactor;
            emitter.velocityScale *= scaleFactor;
